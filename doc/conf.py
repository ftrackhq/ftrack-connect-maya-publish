...
'''ftrack-connect-maya-publish documentation build configuration file.'''
...
project = u'ftrack-connect-maya-publish'
...
with open(
    os.path.join(
        ...
        'ftrack_connect_maya_publish', '_version.py'
    )
) as _version_file:
    _version = re.match(
