...
class PublishScene(ftrack_connect_pipeline.asset.PublishAsset):
...
def register(session):
    ...
    geo_asset = ftrack_connect_pipeline.asset.Asset(
        ...
        publish_asset=PublishScene(
            label=IDENTIFIER,
            description='publish entire scene to ftrack.',
            icon='http://www.clipartbest.com/cliparts/9c4/ekk/9c4ekkocE.svg'
        )
    )
