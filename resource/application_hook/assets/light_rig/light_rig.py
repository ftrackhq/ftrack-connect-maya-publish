...
class PublishLightRig(ftrack_connect_pipeline.asset.PublishAsset):
...
def register(session):
    ...
    geo_asset = ftrack_connect_pipeline.asset.Asset(
        ...
        publish_asset=PublishLightRig(
            label=IDENTIFIER,
            description='publish light rig to ftrack.',
            icon='http://www.clipartbest.com/cliparts/jix/zko/jixzkokET.jpeg'
        )
    )
